...
namespace GL
{
    ...
    public:
        FpCam(Camera3D *_cam, GLFWwindow *_window, float move = 6, float rot = 4, float mouse = 0.2) : CameraControler(_cam,_window), movement(move), rotation(rot), mouseSpeed(mouse)
        {
